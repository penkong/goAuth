...
ALTER TABLE "users" ADD FOREIGN KEY ("account_user_id") REFERENCES "accounts_users" ("id");

ALTER TABLE "users" ADD FOREIGN KEY ("apps_id") REFERENCES "apps" ("id");

ALTER TABLE "teams" ADD FOREIGN KEY ("ceo") REFERENCES "users" ("id");

ALTER TABLE "teams" ADD FOREIGN KEY ("manager") REFERENCES "users" ("id");

ALTER TABLE "teams" ADD FOREIGN KEY ("hr") REFERENCES "users" ("id");

ALTER TABLE "teams" ADD FOREIGN KEY ("tech_guy") REFERENCES "users" ("id");

ALTER TABLE "teams" ADD FOREIGN KEY ("account_id") REFERENCES "accounts" ("id");

ALTER TABLE "teams" ADD FOREIGN KEY ("app_id") REFERENCES "apps" ("id");

ALTER TABLE "accounts" ADD FOREIGN KEY ("user_id") REFERENCES "users" ("id");

ALTER TABLE "accounts" ADD FOREIGN KEY ("team_id") REFERENCES "teams" ("id");

ALTER TABLE "accounts_users" ADD FOREIGN KEY ("account_main") REFERENCES "accounts" ("id");

ALTER TABLE "accounts_users" ADD FOREIGN KEY ("account_2") REFERENCES "accounts" ("id");

ALTER TABLE "accounts_users" ADD FOREIGN KEY ("account_3") REFERENCES "accounts" ("id");

ALTER TABLE "accounts_users" ADD FOREIGN KEY ("account_4") REFERENCES "accounts" ("id");

ALTER TABLE "accounts_users" ADD FOREIGN KEY ("account_5") REFERENCES "accounts" ("id");
...
CREATE INDEX ON "accounts_users" ("id");

CREATE INDEX ON "accounts_users" ("account_main");
...
COMMENT ON COLUMN "users"."account_user_id" IS 'one to many, user is parent';
...
COMMENT ON COLUMN "accounts_users"."rv" IS 'use for handle hybrid concurrncy';
