...
VALUES 
  ...
  (
    "the_cc", 
    "the company that will do best things for the world",
    "sweden",
    "europe",
    "mazdak Nazemi",
    "no 34, Solna, Stockholm",
    1,
    1
  );
...
INSERT INTO teams_companies
  (team_id, company_id)
VALUES
  (1,1);

INSERT INTO teams_apps 
  (team_id, app_id)
VALUES 
  (1, 1),
  (1, 2),
